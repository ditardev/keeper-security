...
class RestoreService(
    ...
    fun signRestore(restoreDto: RestoreDto): ResponseEntity<*>? {
        val userEntity = userRepository.findUserEntityByEmail(restoreDto.email)
            ?: throw ResourceAlreadyExistException(Messages.USER_WITH_USERNAME + "${restoreDto.email}" + Messages.NOT_FOUND)
        ...
        mailService.sendMail(
            ...
            generateMessage(restoreDto.email)
        )
    ...
    fun generateMessage(userEmail: String): String{
